        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="POST">
                    ...
                    $data = mysqli_query($conn, "SELECT tb_doswal.*, tb_pegawai.nama,tb_pegawai.nip_npak,tb_pegawai.id_pegawai FROM tb_doswal, tb_pegawai WHERE tb_doswal.id_pegawai = tb_pegawai.id_pegawai AND id_doswal = '$id'");
