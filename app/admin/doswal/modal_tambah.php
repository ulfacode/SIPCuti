        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="POST">
                    <?php
                    $pgw = sql("SELECT p.id_pegawai ,p.nama, p.nip_npak FROM tb_pegawai AS p, tb_hak_akses AS hak, tb_jabatan AS jb WHERE p.id_pegawai=hak.id_pegawai AND hak.id_jabatan=jb.id_jabatan AND p.status = 'Aktif' AND jb.nama_jabatan='Dosen Wali'");
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_pegawai" class="form-control select2bs4" data-placeholder="Pilih Dosen Wali" style="width: 100%;" required>
                            <option value=""></option>
                            <?php
