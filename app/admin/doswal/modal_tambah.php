        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="POST">
                    <?php
                    $pgw = sql("SELECT p.nama, p.nip_npak FROM tb_pegawai AS p, tb_hak_akses AS hak, tb_jabatan AS jb WHERE p.nip_npak=hak.nip_npak AND hak.id_jabatan=jb.id_jabatan AND p.status = 'Aktif' AND jb.nama_jabatan='Dosen Wali'");
                    ?>
