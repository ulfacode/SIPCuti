    ...
    <center>
        ...
        <table width="600">
            ...
            <tr class="text2">
                ...
                <td width="30">b.</td>
                <td width="">
                    bahwa untuk keperluan di atas, perlu diterbitkan Surat Keputusan Direktur Politeknik Negeri Cilacap
                    tentang Pengaktifan Kembali dari Cuti Kuliah Mahasiswa.
                </td>
            </tr>
