                                ...
                                <div class="card card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <ul class="list-group list-group-unbordered mb-3">
                                            ...
                                            <li class="list-group-item">
                                                <a class="btn btn-info float-right" data-toggle="modal" data-target="#modal-edit<?php echo $pgw['nip_npak']; ?>">
                                                                ...
                                                                <form action="" method="POST">
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="email" class="form-control" name="email" maxlength="15" value="<?= $pegawai["email"]; ?>" required>
                                                                        </div>
                                                                        <div class="form-group">
