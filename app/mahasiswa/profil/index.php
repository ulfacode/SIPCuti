                                                        ...
                                                        <form action="" method="POST">
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email" class="form-control" name="email" maxlength="100" value="<?= $mahasiswa["email"]; ?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="no_telp" class="form-control" type="number" maxlength="13" name="no_telp" value="<?= $mahasiswa["no_telp"]; ?>" required="required">
                                                                </div>
                                                            <?php
                                                            }
                                                            ?>
